...
TESTWORDLOC:	MACRO
TestWord\@:	
	lea	TestWordTxt,a0		; Print the start of line tst word
	lea	.tstwordtxt,a1
	bra	DumpSerial
.tstwordtxt	
	move.w	#\1,d1
...
.space	
	...
	move.w	#\1,d1
	lea	.ret1,a4
	bra	TestWordMemWrite
.ret1
	lea	CrLftxt,a0		; Print the start of line tst word
	lea	.retcrlf,a1
	bra	DumpSerial
.retcrlf
	ENDM
...
atari = 1					; Set to 1 for atari hardware
...
strstart:
	...
	dc.b	"$VER: DiagROM Atari ST Hacked by Stephen Leary. "
...
; Code in ROM mode
	...
	move.b  #$0a,$ffff8001.w       ; set hw to 2 banks by 2 mb (reg 0xffff8001 - memorycontroller) 
...
code:
	...
	ifeq	atari	    ; cant write to address 0 on the atari.
...
parfatxt:
	dc.b	"- Parallel Code $fa - Detected memory in use, we now have a stack etc",$a,$d,0
parf9txt:
